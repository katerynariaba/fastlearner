...
namespace FastLearner.Db.Migrations
{
    ...
    [Migration("20210317124751_DeleteCommentForeignKey")]
    partial class DeleteCommentForeignKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastLearner.Db.DomainModels.Lecture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FastLearner.Db.DomainModels.QuestionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FastLearner.Db.DomainModels.StudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FastLearner.Db.DomainModels.Questionnaire", b =>
                {
                    b.HasOne("FastLearner.Db.DomainModels.Lecture", "Lecture")
                        .WithOne()
                        .HasForeignKey("FastLearner.Db.DomainModels.Questionnaire", "LectureId");
            ...
            modelBuilder.Entity("FastLearner.Db.DomainModels.StudentAnswer", b =>
                {
                    b.HasOne("FastLearner.Db.DomainModels.QuestionAnswer", "Answer")
                        .WithMany()
